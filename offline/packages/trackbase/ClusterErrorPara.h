...
class ClusterErrorPara
{
 public:
  ...
  double mvtx_phi_error(TrkrCluster *cluster) const;
  double mvtx_phi_error(const TrkrCluster *cluster) const;
  double mvtx_z_error(TrkrCluster *cluster) const;
  double mvtx_z_error(const TrkrCluster *cluster) const;
  double intt_phi_error(int layer, TrkrCluster *cluster) const;
  double intt_z_error(TrkrCluster *cluster) const;
  double intt_phi_error(int layer, const TrkrCluster *cluster) const;
  double intt_z_error(const TrkrCluster *cluster) const;
